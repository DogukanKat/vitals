...
public final class Sec001ActuatorExposureRule implements StaticRule {
    ...
    private static final String HELP_URL = "https://github.com/vitals-dev/vitals/blob/main/docs/rules/SEC-001.md";
    private static final String KEY = "management.endpoints.web.exposure.include";
    private static final Set<String> SENSITIVE_ENDPOINTS =
            Set.of("heapdump", "shutdown", "env", "configprops", "threaddump", "httptrace", "httpexchanges");
